...
if __name__ == "__main__":
    ...
    # run_training_neural_model(model=MLP_models.MLP_Nanofins_Dense1024_U350_H600(dtype=tf.float32), epochs=10, miniEpoch=1000, batch_size=2**19, lr=1e-3)
     run_training_neural_model(model=MLP_models.MLP_Nanofins_Dense512_U350_H600(dtype=tf.float32), epochs=50000, miniEpoch=1000,batch_size=500, lr=1e-3, verbose=False)
